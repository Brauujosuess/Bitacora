...
const FloatButtonGroup = props => {
  ...
  const {
    ...
    floatButtonProps = __rest(props, ["prefixCls", "className", "style", "shape", "type", "icon", "closeIcon", "description", "trigger", "children", "onOpenChange", "open", "onClick"]);
  const {
    direction,
    getPrefixCls,
    floatButtonGroup
  ...
  const triggerOpen = (0, _rcUtil.useEvent)(nextOpen => {
    if (open !== nextOpen) {
      setOpen(nextOpen);
  ...
  }, trigger && ['click', 'hover'].includes(trigger) ? (/*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_rcMotion.default, {
    visible: open,
